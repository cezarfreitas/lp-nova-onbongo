  ...
  return (
    <footer className="bg-dark text-light py-8 sm:py-12 px-4">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start gap-3 mt-4">
              <a
                ...
                className="w-8 h-8 bg-light/10 hover:bg-accent rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110"
        ...
        {/* Divisor */}
        <div className="border-t border-light/20 pt-4 sm:pt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            {/* Copyright */}
            <div className="text-light/70 text-xs sm:text-sm text-center sm:text-left">
              © {new Date().getFullYear()} Onbongo. Todos os direitos reservados.
            </div>

            {/* Desenvolvido por */}
            <div className="text-light/70 text-xs sm:text-sm text-center sm:text-right">
