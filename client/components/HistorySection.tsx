...
const HistorySection = memo(function HistorySection() {
  return (
    <section className="py-8 sm:py-12 px-4 bg-dark text-light">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Content */}
        <p className="text-light/90 text-sm sm:text-base md:text-lg leading-relaxed mb-6 sm:mb-8 max-w-3xl mx-auto px-2">
